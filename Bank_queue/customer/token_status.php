    ...
    <div class="token-display">
        ...
        <div class="token-chip">
            ...
            <div class="token-chip-small">
                <span id="status"><?php echo htmlspecialchars($token['status']); ?></span>
            </div>
        </div>
        <div class="token-chip">
            <div class="token-chip-label">Assigned Counter</div>
            <div class="token-chip-small">
                <span id="counter"><?php echo $token['counter_name'] ? htmlspecialchars($token['counter_name']) : 'Not assigned yet'; ?></span>
            </div>
        </div>
    </div>

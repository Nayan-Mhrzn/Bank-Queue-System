...
<section class="card">
    ...
    <form method="GET">
        <label for="code"><i class="fa-solid fa-barcode"></i> Token Code</label>
        <input type="text" name="code" id="code" placeholder="e.g. D7" required style="letter-spacing: 0.1em; font-weight: 600;">
        <button type="submit">
